...
import closeIcon from '../images/closeIcon.svg'; // Import the close icon
        ...
        <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
          ...
          <div className="sm:hidden flex flex-1 justify-end items-center">
            ...
            {toggle ? (
              ...
              <img
                src="https://lohitcdn.blob.core.windows.net/portfoliocdn/Etc/menu.svg"
                alt="menu"
                className="w-6 h-6 object-contain cursor-pointer"
            ...
            <div className={`p-4 bg-gray-800 absolute top-14 right-0 mx-2 my-2 min-w-[120px] z-10 rounded-xl ${toggle ? "flex" : "hidden"}`}>
              {renderNavLinks(true)}
            </div>
          </div>
        </div>
