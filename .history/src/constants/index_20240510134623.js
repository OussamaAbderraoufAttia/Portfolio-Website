...
export const technologies = [
  ...
  { name: "TensorFlow", icon: "https://www.pngwing.com/en/search?q=tensorflow" },  // Replace with your desired TensorFlow icon location
  { name: "OpenCV", icon: "https://opencv.org/resources/media-kit/" },  // Replace with your desired OpenCV icon location
];
